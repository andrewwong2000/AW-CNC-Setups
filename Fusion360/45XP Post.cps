...
description = "Hypertherm 45XP";
vendor = "AW";
vendorUrl = "http://www.caminventions.com";
legal = "Copyright (C) 2012-2018 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 24000;
highFeedrate = (unit == IN) ? 100 : 2500;

longDescription = "Post for Hypertherm 45XP";
...
properties = {
  ...
  pierceDelay: 0, // specifies the delay to pierce in seconds 0 because THC takes care of this
...
function onPower(power) {
  initialG31 = false;
  /* writeBlock(mFormat.format(power ? 205 : 206)); */
