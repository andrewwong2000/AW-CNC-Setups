...
#define STRING_CONFIG_H_AUTHOR "(AW Octopus Marlin)" // <-- changed:  Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AW TAZ 6" // <-- changed
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Taz6
#define DEFAULT_Kp 59.79 // <-- changed
#define DEFAULT_Ki 5.79 // <-- changed
#define DEFAULT_Kd 154.29 // <-- changed
 ...
 */
#define MAX_BED_POWER 255 // <-- changed:  limits duty cycle to bed; 255=full current

#if ENABLED(PIDTEMPBED)
  //#define MIN_BED_POWER 0
  //#define PID_BED_DEBUG // Sends debug data to the serial port.

  //24v 250W silicone heater into 4mm borosilicate (AW TAZ6)
  #define DEFAULT_bedKp 37.56 // <-- changed
  #define DEFAULT_bedKi 3.23 // <-- changed
  #define DEFAULT_bedKd 291.31 // <-- changed
...
#define USE_PROBE_FOR_Z_HOMING // AW TAZ6 changed
 ...
 */
#define FIX_MOUNTED_PROBE // AW TAZ6

/**
 * Use the nozzle as the probe, as with a conductive
 * nozzle system or a piezo-electric smart effector.
 */
// #define NOZZLE_AS_PROBE // <-- AW TAZ6 removed
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-33, -25, -4.17} // <-- changed
...
#define Z_PROBE_SPEED_FAST 400 // <-- changed AW TAZ6

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_SPEED_SLOW 30 // <-- changed
...
#define Z_PROBE_OFFSET_RANGE_MIN -5 // <-- changed
...
#define Z_AFTER_HOMING  6      // (mm) Height to move to after homing Z AW TAZ6
...
#define AUTO_BED_LEVELING_BILINEAR //AW TAZ6
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5 // <-- changed AW TAZ6
  #define GRID_MAX_POINTS_Y 5 // <-- changed AW TAZ6
...
#define Z_SAFE_HOMING // <-- changed
  ...
  #define Z_SAFE_HOMING_X_POINT 180 // <-- changed:  X point for Z homing AW TAZ6
  #define Z_SAFE_HOMING_Y_POINT 180 // <-- changed:  Y point for Z homing AW TAZ6
#endif
 ...
 *
 */
//#define NOZZLE_CLEAN_FEATURE // <-- changed AW TAZ6
